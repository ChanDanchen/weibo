...
def Prepro(content):
    ...
    pickle.dump(content_comment, open('./content21.pkl', 'wb'))
...
#     stop_words.extend(['进口'])
    ...
    print("content读取")
    f = codecs.open(r'F:\PycharmProjects\untitled\weibo-analysis-and-visualization-master\weibo_analysis_and_visualization\Agu_content1.json', 'r', 'UTF-8-sig')
    content = []
